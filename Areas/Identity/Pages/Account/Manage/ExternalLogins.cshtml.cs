    ...
    public class ExternalLoginsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostRemoveLoginAsync(string loginProvider, string providerKey)
        {
            ...
            if (!result.Succeeded)
            {
                ...
                // throw new InvalidOperationException(_localizer["Unexpected error occurred removing external login for user with ID '{0}'.", userId]);
            }
        ...
        public async Task<IActionResult> OnGetLinkLoginCallbackAsync()
        {
            ...
            if (info == null)
            {
                throw new InvalidOperationException(_localizer["Unexpected error occurred loading external login info for user with ID '{0}'.", user.Id]);
            }
            ...
            if (!result.Succeeded)
            {
                ...
                return RedirectToPage();
                // throw new InvalidOperationException(_localizer["Unexpected error occurred adding external login for user with ID '{0}'.", user.Id]);
            }
